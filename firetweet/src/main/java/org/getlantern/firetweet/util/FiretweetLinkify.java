...
import org.getlantern.firetweet.text.FiretweetURLSpan;
...
import static org.getlantern.firetweet.util.MediaPreviewUtils.AVAILABLE_IMAGE_SHUFFIX;
import static org.getlantern.firetweet.util.RegexUtils.matcherEnd;
import static org.getlantern.firetweet.util.RegexUtils.matcherGroup;
import static org.getlantern.firetweet.util.RegexUtils.matcherStart;
...
public final class FiretweetLinkify implements Constants {
    ...
    public FiretweetLinkify(final OnLinkClickListener listener) {
        this(listener, VALUE_LINK_HIGHLIGHT_OPTION_CODE_BOTH);
    }

    public FiretweetLinkify(final OnLinkClickListener listener, final int highlightOption) {
        this(listener, highlightOption, true);
    }

    public FiretweetLinkify(final OnLinkClickListener listener, boolean addMovementMethod) {
        this(listener, VALUE_LINK_HIGHLIGHT_OPTION_CODE_BOTH, addMovementMethod);

    }

    public FiretweetLinkify(final OnLinkClickListener listener, final int highlightOption, boolean addMovementMethod) {
    ...
    private void applyLink(final String url, final String orig, final int start, final int end,
        ...
        final FiretweetURLSpan span = new FiretweetURLSpan(url, orig, accountId, extraId, type, sensitive,
