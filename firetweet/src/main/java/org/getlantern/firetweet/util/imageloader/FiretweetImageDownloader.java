...
package org.getlantern.firetweet.util.imageloader;
...
import static org.getlantern.firetweet.util.Utils.getImageLoaderHttpClient;
import static org.getlantern.firetweet.util.Utils.getNormalTwitterProfileImage;
import static org.getlantern.firetweet.util.Utils.getRedirectedHttpResponse;
import static org.getlantern.firetweet.util.Utils.getTwitterAuthorization;
import static org.getlantern.firetweet.util.Utils.getTwitterProfileImageOfSize;

public class FiretweetImageDownloader extends BaseImageDownloader implements Constants {
    ...
    public FiretweetImageDownloader(final Context context, final boolean fullImage, final boolean useThumbor) {
        super(context);
        mContext = context;
