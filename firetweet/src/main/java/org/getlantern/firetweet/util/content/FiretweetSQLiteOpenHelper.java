...
public final class FiretweetSQLiteOpenHelper extends SQLiteOpenHelper implements Constants {

    private final Context mContext;

    public FiretweetSQLiteOpenHelper(final Context context, final String name, final int version) {
