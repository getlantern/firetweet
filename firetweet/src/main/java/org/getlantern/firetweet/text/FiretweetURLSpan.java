...
public class FiretweetURLSpan extends URLSpan implements Constants {
    ...
    public FiretweetURLSpan(final String url, final String orig, final long accountId, final long extraId,
