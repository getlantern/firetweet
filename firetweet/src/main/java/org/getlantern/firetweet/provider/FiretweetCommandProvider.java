...
import org.getlantern.firetweet.provider.FiretweetCommands.Refresh;
import org.getlantern.firetweet.util.AsyncTwitterWrapper;
import org.getlantern.firetweet.util.PermissionsManager;

public class FiretweetCommandProvider extends ContentProvider implements Constants {
	...
	static {
		COMMAND_URI_MATCHER.addURI(FiretweetCommands.AUTHORITY, Refresh.ACTION_REFRESH_ALL, CODE_REFRESH_ALL);
	}
