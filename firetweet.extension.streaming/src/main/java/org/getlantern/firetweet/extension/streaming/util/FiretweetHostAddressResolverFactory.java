 ...
 */
public class FiretweetHostAddressResolverFactory implements HostAddressResolverFactory {
    private final Context context;

    public FiretweetHostAddressResolverFactory(Context context) {
        this.context = context;
    }

    @Override
    public HostAddressResolver getInstance(HttpClientConfiguration conf) {
        return new FiretweetHostAddressResolver(context);
    }
}
